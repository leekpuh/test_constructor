...
<template>
  <div class="px-5">
    <div class="h-85 flex flex-col gap-5 pt-2">
      ...
      <div v-if="imagePreviewUrl && !imagePreviewError" class="flex-center">
        <img
          :src="imagePreviewUrl"
      ...
      <p v-if="imagePreviewError">Загрузка не удалась. Проверьте URL ссылку.</p>
    </div>
